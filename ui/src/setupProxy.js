...
module.exports = function(app) {
  ...
  app.use('/api/', withLogs({target: 'http://127.0.0.1:2022/'}));
  app.use('/rtc/', withLogs({target: 'http://127.0.0.1:2022/'}));
  app.use('/*/*.(flv|m3u8|ts|aac|mp3)', withLogs({target: 'http://127.0.0.1:2022/'}));
